...
[<assembly: AssemblyTitleAttribute("hometasks.Tests")>]
[<assembly: AssemblyProductAttribute("hometasks")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "hometasks.Tests"
    let [<Literal>] AssemblyProduct = "hometasks"
